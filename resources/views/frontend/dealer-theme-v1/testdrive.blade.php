                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="testdrive-content">
                        ...
                        <div class="testdrive-stats">
                            <div class="stat-item">
                                <span class="number"><span data-purecounter-start="0" data-purecounter-end="{{ $profile->project_number }}"
                                        data-purecounter-duration="1" class="purecounter"></span>+</span>
                                <span class="text">Delivery Order</span>
                            </div>
                            <div class="stat-item">
                                <span class="number"><span data-purecounter-start="0" data-purecounter-end="{{ $profile->client_number }}"
                                        data-purecounter-duration="1" class="purecounter">98</span>%</span>
                                <span class="text">Pelanggan Puas</span>
                            </div>
                            <div class="stat-item">
                                <span class="number"><span data-purecounter-start="0" data-purecounter-end="{{ $profile->experience_number }}"
                                        data-purecounter-duration="1" class="purecounter">10</span>+</span>
                    ...
                    <div class="testdrive-form">
                        ...
                        <form action="{{ route('testdrive.store') }}" method="post" id="testdrive-form">
                            ...
                            <div class="form-group mt-3">
                                <input type="text" class="form-control" name="email" placeholder="Email (opsional)"
                                    id="email">
                            ...
                            <div class="form-group mt-3">
                                <select class="form-control select2" name="product" id="product"
                                    data-placeholder="Pilih Mobil TestDrive">
                            ...
                            <div class="form-group mt-3">
                                <input type="text" class="form-control datepicker" datepicker-min="today"
                                    datepicker-body="modal" datepicker-closeonblur="true"
                                    datepicker-format="DD MMM YYYY" name="schedule_date" placeholder="Jadwal Testdrive"
                                    id="schedule_date">
                                <div class="invalid-feedback" id="error-schedule_date"></div>
                            </div>
                            <div class="form-group mt-3">
                                <textarea name="note" class="form-control" id="note" cols="30" rows="10"
                                    placeholder="Catatan" id="note"></textarea>
