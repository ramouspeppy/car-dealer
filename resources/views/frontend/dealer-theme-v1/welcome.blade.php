                ...
                <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
                    <div class="hero-text">
                        ...
                        <div class="hero-actions">
                            ...
                            <a href="#contact" class="btn btn-outline">Tanya Angsuran ?</a>
                        </div>
...
@endpush
<section id="get-a-quote" class="get-a-quote section" data-builder="section">
                ...
                <div class="about-content">
                    ...
                    <div class="stats-grid">
                        ...
                        <div class="stat-item">
                            <span class="stat-number">
                                <span class="purecounter" data-purecounter-start="0"
                                    data-purecounter-end="{{ $profile->project_number }}" data-purecounter-duration="1">
                                </span>+</span>
                        ...
                        <div class="stat-item">
                            <span class="stat-number">
                                <span class="purecounter" data-purecounter-start="0"
                                    data-purecounter-end="{{ $profile->client_number }}"
                        ...
                        <div class="stat-item">
                            <span class="stat-number">
                                <span class="purecounter" data-purecounter-start="0"
                                    data-purecounter-end="{{ $profile->experience_number }}"
                                    data-purecounter-duration="1"></span>+</span>
...
<section id="promo-list" class="promo-list section" data-builder="section">
                ...
                <div class="promo-list-card">
                    ...
                    <div class="promo-info">
                        ...
                        <div class="promo-meta">
                            <span><i class="bi bi-calendar3"></i> {{ $promo->effective_format
                                }}</span>
...
<section id="product-cards" class="product-list-cards section" data-builder="section">
    <div class="container section-title" data-aos="fade-up" data-builder="section-title">
                    ...
                    <div class="product-list-content">
                        <a href="{{ route('product.show',$product->slug) }}">
                            ...
                            <div class="product-list-image">
                                <img src="{{ $product->image_url }}" alt="{{ $product->product }}" class="img-fluid"
                                    loading="lazy">
                            </div>
                        </a>
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="row gy-4 portfolio-container isotope-container" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div
                            class="col-lg-4 col-md-4 portfolio-item isotope-item delivery-{{ $delivery->product->slug }}">
                                ...
                                <div class="portfolio-info">
                                    <div class="content">
                                        ...
                                        <div class="portfolio-links">
                                            <a href="{{ $delivery->image_url }}" class="glightbox"><i
...
<section id="testimonials-2" class="testimonials-2 section" data-builder="section">
                        ...
                        <div class="row gy-4 justify-content-center">
                            ...
                            <div class="col-lg-2 text-center">
                                <img src="{{ $testimony->image_url }}"
                                    class="img-fluid w-50 w-md-50 w-lg-100 testimonial-img"
                                    alt="{{ $testimony->name }}">
                            </div>
                        </div>
                    </div>
