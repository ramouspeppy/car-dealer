                    ...
                    <div class="container">
                        ...
                        <div class="row justify-content-between gy-4">
                            ...
                            <div class="col-lg-8" data-aos="zoom-out" data-aos-delay="200">
                                <form action="{{ route('consultation.store') }}" id="ask-question" method="POST"
                                    class=class="needs-validation @if($errors->any()) was-validated @endif" novalidate>
                                    @csrf
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="field-wrap">
                                                ...
                                                <select name="budget"
                                                    class="form-control selectric @error('budget') is-invalid @enderror">
                                                    <option value="">-- Pilih Budget --</option>
                                                    <option value="< 100 juta" {{ old('budget')=='< 100 juta'
                                                        ? 'selected' : '' }}>
                                                        < 100 juta</option>
                                                    <option value="100 - 200 juta" {{ old('budget')=='100 - 200 juta'
                                                        ? 'selected' : '' }}>100 - 200 juta</option>
                                                    <option value="200 - 300 juta" {{ old('budget')=='200 - 300 juta'
                                                        ? 'selected' : '' }}>200 - 300 juta</option>
                                                    <option value="> 300 juta" {{ old('budget')=='> 300 juta'
                                                        ? 'selected' : '' }}> >
                                                        300 juta</option>
                                                </select>
                                                <div class="invalid-feedback"><i class="bi bi-exclamation-circle"></i>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="field-wrap">
                                                ...
                                                <select name="payment_type" id="payment_type"
                                                    class="form-control selectric @error('payment_type') is-invalid @enderror">
                                        ...
                                        <div class="col-sm-12" id="tenorField">
                                            <div class="field-wrap">
                                                <label>Tenor</label>
                                                <select name="tenor"
                                                    class="form-control selectric @error('tenor') is-invalid @enderror">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="field-wrap">
                                                ...
                                                <textarea name="message" rows="4"
                                                    placeholder="Contoh: Butuh mobil keluarga, irit BBM"
