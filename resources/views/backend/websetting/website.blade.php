                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-3 text-center">
                                    <div class="form-group">
                                        ...
                                        <x-jasni-bootstrap name="site_logo" :model="config('settings.site_logo_url')" />                                        
                                    </div>
                                </div>
                                <div class="col-12 col-md-3 text-center">
                                    <div class="form-group">
                                        <label class="form-control-label">Favicon</label>
                                        <x-jasni-bootstrap name="favicon" :model="config('settings.favicon_url')" />
                                    </div>
                                </div>
                                <div class="col-12 col-md-3 text-center">
                                    <div class="form-group">
                                        <label class="form-control-label">Open Graph Image</label>
                                        <x-jasni-bootstrap name="og_image" :model="config('settings.og_image_url')" />
                                    </div>
                                </div>
                                <div class="col-12 col-md-3 text-center">
                                    <div class="form-group">
                                        <label class="form-control-label">Footer Background</label>
                                        <x-jasni-bootstrap name="bg_footer" :model="config('settings.bg_footer_url')" />
                                    </div>
                                </div>
                            </div>
                        </div>
