...
@section('title', 'Create New Photo Delivery - '.config('settings.site_name'))
@section('breadcrumb')
<div class="nb">
    <div class="nb-header">
        ...
        <h1>Create New Photo Delivery</h1>
        <div class="nb-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Create New Photo Delivery</div>
        </div>
    </div>
</div>
@endsection
...
<section class="section">
    <div class="section-body">
        <form action="{{ route('backend.photo-delivery.store') }}" enctype="multipart/form-data" method="post"
            id="form-photo-delivery">
            @csrf
